...
@section('content')
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                ...
                <div class="mil-inner-banner">
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            ...
                            <h1 class="mil-mb-60">{{__('general.headline2')}} </h1>
                            <div class="row paragraph">
                                <div class="col-md-7 col-lg-5">

                                    <p class="mil-dark-soft mil-mb-60">{{__('general.headline details')}}</p>
                            ...
                            <div class="container mil-p-120-60">
                                <div class="row">
                                    <div class="col-lg-5">
                                        ...
                                        <div class="mil-lines-place mil-dark"></div>

                                    </div>
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <a href="/service/UI / UX DESIGN/details" class="mil-service-card-lg mil-more">
                                                    <h4 class="mil-up mil-mb-30">{{__('general.UI / UX DESIGN')}}</h4>
                                                    <p class="mil-descr  mil-up mil-mb-30">{{__('general.service 1')}}</p>
                                                    <ul class="mil-service-list mil-mb-30">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="/service/APP DEVELOPMENT/details" class="mil-service-card-lg mil-more">
                                                    <h4 class=" mil-up mil-mb-30">{{__('general.APP DEVELOPMENT')}}</h4>
                                                    <p class="mil-descr  mil-up mil-mb-30">{{__('general.service 2')}}</p>
                                                    <ul class="mil-service-list  mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                                                        <li class="mil-up">Methodologies</li>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="/service/WEBSITE DESIGN AND DEVELOPMENT/details" class="mil-service-card-lg mil-more">
                                                    <h4 class=" mil-up mil-mb-30">{{__('general.WEBSITE DESIGN AND DEVELOPMENT')}}</h4>
                                                    <p class="mil-descr  mil-up mil-mb-30">{{__('general.service 3')}}</p>
                                                    <ul class="mil-service-list  mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                                                        <li class="mil-up">Methodologies</li>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="/service/CREATIVE CONSULTING AND DEVELOPMENT/details" class="mil-service-card-lg mil-more">
                                                    <h4 class=" mil-up mil-mb-30">{{__('general.CREATIVE CONSULTING AND DEVELOPMENT')}}</h4>
                                                    <p class="mil-descr  mil-up mil-mb-30">{{__('general.service 4')}}</p>
                                                    <ul class="mil-service-list  mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                                                        <li class="mil-up">Methodologies</li>
                ...
                <!-- call to action -->
                <section class="mil-soft-bg call">
                    <div class="container mil-p-120-120">
                        ...
                        <div class="mil-center">
                            <h2 class="mil-up mil-mb-60">{{__('general.contatct paragraph')}}</h2>
                            <div class="mil-up"><a href="/contact" class="mil-button mil-arrow-place"><span>{{__('general.contact')}}</span></a></div>
                        </div>
                    </div>
                </section>
                <!-- call to action end -->
